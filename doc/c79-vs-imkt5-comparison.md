# c79 (cchyperframes) vs imkt5 — relatório de comparação
...
>
> Data: 2026-04-19. Refs: `cchyperframes@HEAD`, `imkt5@53b1538`.
...
| Eixo | c79 (Hyperframes) | imkt5 (ffmpeg-local) |
|---|---|---|
...
| Elemento | c79 may-shorts-19 | imkt5 quick | imkt5 pro |
|---|---|---|---|
...
| # | Técnica c79 | Viabilidade imkt5 | Custo | Ganho |
|---|---|---|---|---|
...
| # | Técnica c79 | Viabilidade imkt5 | Custo |
|---|---|---|---|
...
**Leitura:** c79 é um **estúdio bespoke de 1 pessoa**. imkt5 é uma
...
|---|---|
| **Post Instagram carrossel 7 slides/dia** | 🏆 imkt5 — c79 não faz |
| **Reels/TikTok automatizado 20s + narração sintética** | 🏆 imkt5 — volume + queue + multi-tenant |
...
| **Conteúdo educacional B2B em escala (100+ vídeos/mês)** | 🏆 imkt5 — c79 não escala |
| **A/B testing de hook+cta em paid media** | 🏆 imkt5 — `video-ab-suggest` nativo |
...
2. **imkt5 = plataforma de produção automatizada.** 15-20× mais rápido,
...
- `imkt5/doc/video-style-study.md` — estudo prévio mkt3 + c79 (70% paridade)
- `imkt5/workers/ffmpeg-local/server.py:1647` — nosso renderer atual
