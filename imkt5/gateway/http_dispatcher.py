...
from imkt5.capabilities.matcher import NoWorkerAvailable, select_worker
from imkt5.capabilities.registry import CapabilityRegistry
from imkt5.types.jobs import Job

log = logging.getLogger("imkt5.dispatcher")
...
class HttpDispatcher:
    ...
    async def _call_worker(self, worker, job: Job) -> dict[str, Any]:
        ...
        timeout = float(worker.timeout_seconds) if worker.timeout_seconds else self._timeout
